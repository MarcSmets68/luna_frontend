...
import { OfferteEditPage } from "@/features/offertes/components/offerte-edit-page";
...
export default async function OfferteBewerken({
  params,
}: {
  ...
  return (
    <AppShell>
      <OfferteEditPage offerte={offerte} lijnen={lijnen} />
    </AppShell>
  );
}
